define(["client.property-panel/component-utils", "client.property-panel/components/components", "translator", "objects.utils/number-formatter", "objects.utils/date-formatter", "general.utils/number-formatting"], function(a, b, c, d, e, f) {
		function g(a, b) {
			...
			console.log(b);
			var c, d, e, f;
			switch (a.qListObjectDef.qDef.qNumberPresentations[0].qType) {
				case "D":
				case "T":
				case "TS":
					f = k, c = p;
				...
				case "M":
					...
					break;
				case "R":
					e = a.qListObjectDef.qDef.qNumberPresentations[0].qDec || ".", d = a.qListObjectDef.qDef.qNumberPresentations[0].qThou;
				default:
					f = n, c = o
			}
			return f.format(c, "undefined" != typeof b ? b : a.qListObjectDef.qDef.qNumberPresentations[0].qFmt, d, e)
		}

		function h(a, b) {
			a.qListObjectDef.qDef.qNumberPresentations[0].qFmt = f.getDefaultNumericFormat(a.qListObjectDef.qDef.qNumberPresentations[0], b)
		}

		function i(a, b, c) {
			return a === f.getDefaultNumericFormat(b.qListObjectDef.qDef.qNumberPresentations[0], c)
		}
		var j, k = new e("", "", "", "D"),
			l = new e("", "", "", "IV"),
			m = new d("", "", "", "M"),
		...
		var j = {
			...
			controller: ["$scope", function(b) {
				...
				}, b.example_title = c.get("properties.numberFormatting.example"), b.example = g(b.data), b.resetting = !1, b.isDefaultFormat = i(b.data.qListObjectDef.qDef.qNumberPresentations[0].qFmt, b.data, b.args.localeInfo), b.showReset = "R" === b.data.qListObjectDef.qDef.qNumberPresentations[0].qType, b.reset = function() {
					b.resetting || (h(b.data, b.args.localeInfo), b.resetting = !0, b.$emit("saveProperties"))
				}, b.$on("datachanged", function() {
					b.example = g(b.data), b.resetting = !1, b.isDefaultFormat = i(b.data.qListObjectDef.qDef.qNumberPresentations[0].qFmt, b.data, b.args.localeInfo), b.showReset = "R" === b.data.qListObjectDef.qDef.qNumberPresentations[0].qType
				})
			}]
		};
		return b.addComponent("kf-dim-number-formatter", j), j
	})